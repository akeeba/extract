 ...
 * build/macos-app.sh: splitting the combined akeeba-extract.exe there yields a
 * clean, Authenticode-signable stub plus a sibling akeeba-extract.phar the
 * patched SFX loads at run time (see build/readme/02-signing-architecture.md).
 *
