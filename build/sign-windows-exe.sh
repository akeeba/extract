#!/usr/bin/env bash
# ============================================================================
# Akeeba Extract — Windows Authenticode signing (Azure Artifact Signing)
...
#
# Usage:
#   ./build/sign-windows-exe.sh <path-to-exe>
#
...
# build/build-all.sh), never from a local/dev compile (git-win-x86) — Azure
